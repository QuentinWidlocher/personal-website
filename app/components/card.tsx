...
export default function Card({ titleSlot, subTitleSlot, children, imgSlot, centered = false }: PropsWithChildren<CardProps>) {
	return (
		<article
			...
			} group flex h-full min-h-[10rem] flex-col rounded-lg bg-slate-500/20 p-5 transition-transform hover:scale-105 hover:bg-gradient-to-tr hover:from-sky-500/50 hover:to-sky-400/60 hover:shadow-lg hover:shadow-sky-500/20`}
		>
