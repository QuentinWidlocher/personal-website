...
interface RepoCardProps {
	repo: Omit<ReposLoaderPayload["repos"][number], "updatedAt">
}

function getIcon(repo: Omit<ReposLoaderPayload["repos"][number], "updatedAt">) {
	if (repo.isTemplate) {
		return (
		...
		<a href={repo.url} target="_blank" rel="noopener">
			...
			>
				<div className="flex flex-wrap items-center justify-between">
					{repo.stars > 0 ? (
						<>
							<div className="flex mt-5 space-x-2 text-base text-slate-200 dark:text-slate-400">
								<StarOutline />
