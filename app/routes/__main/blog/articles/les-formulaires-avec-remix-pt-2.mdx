...
meta:
  ...
  og:description: Valider un formulaire et gérer les erreurs
---

# Les formulaires avec Remix - Partie 2

> Valider un formulaire et gérer les erreurs
...
let validator = z.object({
	...
	password: z.string().min(6, { message: "Le mot de passe doit faire au minimum 6 caractères" }),
